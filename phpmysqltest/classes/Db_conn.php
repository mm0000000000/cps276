...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'mimacdona';//this will be your WCC username
      $dbUsr = 'mimacdona';//this will be your WCC username
      $dbPass = '8DfkIoLym0jYLiS';//this will be the password found in the video.
